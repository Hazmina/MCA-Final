...
namespace OAS
{
    public partial class CalculateSalary : Telerik.WinControls.UI.RadForm
    {
        ...
        StringHandling FS = new StringHandling();
        double Salary;
        public void FethchData()
        {
            try
            {
                ...
                lblStaffNo.Text = SD.Staffid.ToString();
        ...
        public void CalculateSal()
        {
            ...
            try
            {
                ds = db.FetchData("SELECT Sundays = count(*) FROM (SELECT TOP ( datediff(DAY,'" + dtFrom.Value.ToString("yyyy-MM-dd") + "','" + dtTo.Value.ToString("yyyy-MM-dd") + "') + 1 )[Date] = dateadd(DAY,ROW_NUMBER() OVER(ORDER BY c1.name),DATEADD(DD,-1,'" + dtFrom.Value + "')) FROM   [master].[dbo].[spt_values] c1 ) x WHERE  datepart(dw,[Date]) = 1;");
            ...
            try
            {
                ...
                ds = db.FetchData("select isnull((sum(DATEDIFF(HOUR,Att_In,Att_Out)) / 8),0) from Attendance where Att_Date between '" + dtFrom.Value.ToString("yyyy-MM-dd") + "' and '" + dtTo.Value.ToString("yyyy-MM-dd") + "' and RFID_Id='" + lblRFID.Text + "'");
            ...
            if (Convert.ToInt32(lblWHours.Text) > 0)
            {
                CalculateLeaveTaken();
        ...
        public void GenerateSalaryRecipt()
        {
            ...
            Writer.WriteLine("<table width='100%' height='100%' style='border: 1px solid;'><tr><td align='center'>Managed By:- Bharuch Welfare Hospital & Education Trust.<br /><font size='8'>Bharuch Welfare School</font><br /> Welfare Dental & Nursing Building<br /> Nr, Manubar Chokdi Road, Bharuch.<br />Phone:- 02642-112457<br/> <br/> </td></tr>");
            ...
            Writer.WriteLine("<tr height='30px'><td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Adjustment Leave:</b></td><td >" + lblAdj.Text + "</td><td ><b>After Adjustment:</b></td><td >" + lblAdjAdded.Text + "</td></tr><tr height='30px' bgcolor='#99FF33'><td colspan='3' style='border: 1px solid;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Earnings</b></td><td style='border: 1px solid;' align='center'><b>Amount</b></td></tr><tr height='30px'><td colspan='3'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Basic Salary</td><td align='center'>" + FS.ExtractDecimalFromString(lblBS.Text) + "</td></tr>");
            Writer.WriteLine("<tr height='30px'><td colspan='3'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provident Fund " + allwance + "% Deducted</td><td align='center'>-" + FS.ExtractDecimalFromString(lblAD.Text) + "</td></tr><tr height='30px'><td colspan='3'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Leaves Without Pay</td><td align='center'>-" + FS.ExtractDecimalFromString(lblDLC.Text) + "</td></tr><tr height='30px' bgcolor='#99FF33'><td colspan='3' style='border: 1px solid;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total</td><td style='border: 1px solid;' align='center'>" + FS.ExtractDecimalFromString(lblNS.Text) + "</td></tr></table></td></tr>");
        ...
        public void AdjusmentLeave()
        {
            try {
                ...
                lblPendingLeave.Text = PendingLeave.ToString();
            }
            catch (Exception e)
            {
        ...
        private void btnSalary_Click(object sender, EventArgs e)
        {
            ...
            GenerateSalarySlip GSS = new GenerateSalarySlip();
            GSS.ShowDialog();
        }
